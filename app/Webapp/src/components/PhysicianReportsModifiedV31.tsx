...
import ConsultationScoring from "./ConsultationScoringV3";
import {
  useDoctorData,
  DoctorSentenceItem,
  DoctorRewriteItem,
...
const HistoryModal: React.FC<HistoryModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div
        className={cx(
          "relative w-full max-w-2xl max-h-[80vh] overflow-hidden rounded-xl shadow-2xl",
          isDarkMode
                        ...
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <span
                            className={cx(
                              ...
                              getScoreColorForValue(revision.score, isDarkMode)
                            )}
                          >
                            {revision.score ?? "N/A"}
                          </span>
      ...
      >
        ...
        <div className="mb-8">
          <ConsultationScoring
            ...
            highlightPosition={data.score !== null ? Math.round(data.score) : 0}
