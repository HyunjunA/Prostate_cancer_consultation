...
const ConsultationScoring: React.FC<ConsultationScoringProps> = ({
  ...
  return (
    <div className={`w-full max-w-6xl mx-auto p-8 ${outerBg}`}>
      ...
      {/* ═══════════════════════════════════════════════════════════
          NEW: Suggestions for Improvement Section
          ═══════════════════════════════════════════════════════════ */}
      {suggestions && suggestions.length > 0 && (
        ...
        >
          <h3
            className={`text-sm font-semibold uppercase tracking-wider mb-3 ${titleColor}`}
          >
            Suggestions for Improvement
          </h3>
      ...
      {/* ═══════════════════════════════════════════════════════════
          NEW: AI Re-write Section
          ═══════════════════════════════════════════════════════════ */}
      {(onGenerateAIRewrite || aiRewriteText) && (
        <div
          className={`mt-4 rounded-lg border ${sectionBorder} ${sectionBg} p-4`}
        >
          <h3
            className={`text-sm font-semibold uppercase tracking-wider mb-3 ${titleColor}`}
          >
          ...
          {/* AI Rewrite Result or Hint */}
          {aiRewriteText ? (
            // Generated result - Green bubble
            <div
            ...
            >
              {aiRewriteLoading
                ...
                : "AI suggestion will appear here after generation."}
            </p>
          )}
          ...
          <div className="flex gap-3">
            ...
            >
              ...
              {aiRewriteLoading ? "Generating..." : "Generate"}
            </button>
