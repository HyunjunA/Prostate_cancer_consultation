...
//     // Add group for selection area
//     const brushGroup = g.append("g").attr("class", "brush-group");
//     let dragStart = null;
//     let isDragging = false;

//     // Function to check Alt/Option key state
...
//       .style("fill", "none")
//       .style("pointer-events", "all")
//       .style("cursor", "crosshair") // add this line
//       .on("mouseover", () => {
//         focus.style("display", null);
//         selectionGroup.style("opacity", 0.3); // add this line
//       })
...
export const LineChart = ({
  ...
  useEffect(() => {
    ...
    // Add variables to track focus and selection state
    ...
    g.append("rect")
      ...
      .on("mousemove", function (event) {
        ...
        if (isDragging && isAltKey(event)) {
          ...
          brushGroup
            ...
            .attr("fill", "#808080")
            .attr("opacity", 0.3);
          // Skip existing vertical line and tooltip code during drag
          focus.style("display", "none");
          tooltipDiv.style("visibility", "hidden");
          return;
        }
      ...
      <div style="color: #ff6b6b; font-size: ${chartStyles.tooltip.fontSize}">
        Negative: ${
          d.Negative_count !== -1
            ? d.Negative_count
            : "<span style='font-style: italic; color: #666;'>Data not available for this period</span>"
      ...
      <div style="color: #4ecdc4; font-size: ${chartStyles.tooltip.fontSize}">
        Positive: ${
          d.Positive_count !== -1
            ? d.Positive_count
            : "<span style='font-style: italic; color: #666;'>Data not available for this period</span>"
