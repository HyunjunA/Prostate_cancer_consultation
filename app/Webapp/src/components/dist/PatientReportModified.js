...
var StarRating = function (_a) {
    var value = _a.value, onChange = _a.onChange, label = _a.label, isDark = _a.isDark;
    return (react_1["default"].createElement("div", { className: "flex items-center gap-3" },
        ...
        react_1["default"].createElement("div", { className: "flex items-center gap-1" }, [1, 2, 3, 4, 5].map(function (i) { return (react_1["default"].createElement("button", { key: i, type: "button", "aria-label": "Rate " + i, onClick: function () { return onChange(i); }, className: cx("w-8 h-8 rounded-full grid place-items-center border transition", isDark
        ...
        react_1["default"].createElement("div", { className: "max-w-6xl mx-auto" },
                    ...
                    react_1["default"].createElement("div", { className: "text-center" },
                        ...
                        react_1["default"].createElement("div", { className: "mb-8" },
                            react_1["default"].createElement("div", { className: cx("inline-flex rounded-lg p-1", isDarkMode ? "bg-slate-800" : "bg-gray-100") },
                                react_1["default"].createElement("button", { onClick: function () { return setViewMode("topics"); }, className: cx("px-6 py-2 text-sm font-medium rounded-md transition-colors", viewMode === "topics"
                                        ? isDarkMode
                                            ? "bg-blue-700 text-blue-100"
                                            : "bg-blue-600 text-white"
                                        : isDarkMode
                                ...
                                react_1["default"].createElement("button", { onClick: function () { return setViewMode("full"); }, className: cx("px-6 py-2 text-sm font-medium rounded-md transition-colors", viewMode === "full"
                                        ? isDarkMode
                                            ? "bg-blue-700 text-blue-100"
                                            : "bg-blue-600 text-white"
                                        : isDarkMode
            ...
            viewMode === "topics" ? (react_1["default"].createElement("div", { className: cx(isDarkMode ? "bg-slate-900" : "bg-white", "shadow-xl min-h-screen") },
                react_1["default"].createElement("div", { className: "px-6 lg:px-12 py-12 grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-10" },
                    react_1["default"].createElement("div", null,
                        activeTab === null && (react_1["default"].createElement("section", { className: cx("p-8 rounded-xl mb-10", isDarkMode
                            ...
                            react_1["default"].createElement("div", { className: "flex items-start justify-between gap-4 mb-6" },
                                ...
                                react_1["default"].createElement(StarRating, { value: ratings.overall || 0, onChange: function (v) {
                                    ...
                                    }, label: "Was this helpful?", isDark: isDarkMode })),
                        ...
                        activeTab !== null && (react_1["default"].createElement("section", null,
                            ...
                            react_1["default"].createElement("div", { className: cx("p-8 rounded-xl mb-6", isDarkMode
                                    ? "bg-gradient-to-br from-slate-800 to-slate-700 border border-slate-600"
                                    : "bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200") },
                                react_1["default"].createElement("div", { className: "flex items-start justify-between gap-4 mb-6" },
                                    react_1["default"].createElement("h4", { className: cx("text-xl font-semibold", isDarkMode ? "text-slate-200" : "text-gray-800") },
                                        "Summary for ",
                                        activeTab),
                                    react_1["default"].createElement(StarRating, { value: ratings[activeTab] || 0, onChange: function (v) { return setTopicRating(activeTab, v); }, label: "Rate clarity", isDark: isDarkMode })),
                            ...
                            react_1["default"].createElement("div", { className: "mb-8" },
                                react_1["default"].createElement("button", { type: "button", onClick: function () { return toggleKeyVisibility(activeTab); }, className: cx("px-4 py-2 rounded-lg text-sm font-medium mb-4", isDarkMode
                                        ? "bg-slate-800 text-slate-200 hover:bg-slate-700"
                                        : "bg-gray-100 text-gray-700 hover:bg-gray-200") }, showKeys[activeTab]
                                    ? "Hide key statements"
                                    : "Show key statements"),
                                showKeys[activeTab] && (react_1["default"].createElement("div", { className: cx("p-6 rounded-xl border-l-4", isDarkMode
                                        ? "bg-slate-800 border-l-blue-500 border border-slate-700"
                                        : "bg-gray-50 border-l-blue-600 border border-gray-200") },
                                    react_1["default"].createElement("h4", { className: cx("text-lg font-semibold mb-4", isDarkMode ? "text-slate-200" : "text-gray-800") }, "Key Statements from Consultation"),
                                    react_1["default"].createElement("div", { className: "space-y-4" }, (_c = currentTopicData === null || currentTopicData === void 0 ? void 0 : currentTopicData.extractedSentences) === null || _c === void 0 ? void 0 : _c.map(function (sentence, idx) { return (react_1["default"].createElement("div", { key: idx, className: "flex items-start" },
                                        react_1["default"].createElement("div", { className: cx("flex-shrink-0 w-2 h-2 rounded-full mt-2 mr-4", isDarkMode ? "bg-blue-400" : "bg-blue-600") }),
                                        react_1["default"].createElement("p", { className: cx("text-base leading-relaxed", isDarkMode
                                                ? "text-slate-300"
                                                : "text-gray-700") },
                                            "\"",
                                            sentence,
                                            "\""))); })))))))),
                    react_1["default"].createElement("aside", { className: cx("lg:sticky lg:top-6 h-max") },
                        react_1["default"].createElement("div", { className: cx("rounded-2xl p-4", isDarkMode
                            ...
                            react_1["default"].createElement("div", { className: "space-y-2" },
                                react_1["default"].createElement("button", { type: "button", onClick: function () { return setActiveTab(null); }, className: cx("w-full text-left px-3 py-2 rounded-lg text-sm font-medium", activeTab === null
                                        ? isDarkMode
                                            ? "bg-blue-700 text-blue-100"
                                            : "bg-blue-600 text-white"
                                        : isDarkMode
                                ...
                                topicKeys.map(function (topic, idx) { return (react_1["default"].createElement("button", { type: "button", key: topic, onClick: function () { return setActiveTab(topic); }, className: cx("w-full text-left px-3 py-2 rounded-lg text-sm font-medium flex items-center gap-2", activeTab === topic
                                        ? isDarkMode
                                            ? "bg-blue-700 text-blue-100"
                                            : "bg-blue-600 text-white"
                                        : isDarkMode
            ...
            react_1["default"].createElement("div", { className: cx(isDarkMode ? "bg-slate-900" : "bg-white", "shadow-xl min-h-screen") },
                react_1["default"].createElement("div", { className: "px-12 py-12" },
                    ...
                    react_1["default"].createElement("section", { className: cx("p-8 rounded-xl mb-12", isDarkMode
                            ? "bg-gradient-to-br from-slate-800 to-slate-700 border border-slate-600"
                            : "bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200") },
                        react_1["default"].createElement("div", { className: "flex items-start justify-between gap-4 mb-6" },
                            ...
                            react_1["default"].createElement(StarRating, { value: ratings.overall || 0, onChange: function (v) { return setRatings(function (r) { return (__assign(__assign({}, r), { overall: v })); }); }, label: "Was this helpful?", isDark: isDarkMode })),
                        react_1["default"].createElement("p", { className: cx("text-lg leading-relaxed", isDarkMode ? "text-slate-300" : "text-gray-700") }, patientData.overallSummary)),
                    Object.entries(patientData.consultationTopics).map(function (_a, index) {
                        var topicName = _a[0], topicData = _a[1];
                        return (react_1["default"].createElement("div", { key: topicName, className: "relative" },
                            ...
                            react_1["default"].createElement("div", { className: cx("p-8 rounded-xl mb-6", isDarkMode
                                ...
                                react_1["default"].createElement("div", { className: "flex items-start justify-between gap-4 mb-6" },
                                    ...
                                    react_1["default"].createElement(StarRating, { value: ratings[topicName] || 0, onChange: function (v) { return setTopicRating(topicName, v); }, label: "Rate clarity", isDark: isDarkMode })),
                            ...
                            react_1["default"].createElement("div", { className: "mb-10" },
                                react_1["default"].createElement("button", { type: "button", onClick: function () { return toggleKeyVisibility(topicName); }, className: cx("px-4 py-2 rounded-lg text-sm font-medium mb-4", isDarkMode
                                        ? "bg-slate-800 text-slate-200 hover:bg-slate-700"
                                        : "bg-gray-100 text-gray-700 hover:bg-gray-200") }, showKeys[topicName]
                                    ? "Hide key statements"
                                    : "Show key statements"),
                                showKeys[topicName] && (react_1["default"].createElement("div", { className: cx("p-6 rounded-xl border-l-4", isDarkMode
                                        ? "bg-slate-800 border-l-blue-500 border border-slate-700"
                                        : "bg-gray-50 border-l-blue-600 border border-gray-200") },
                                    react_1["default"].createElement("h3", { className: cx("text-lg font-semibold mb-4", isDarkMode ? "text-slate-200" : "text-gray-800") }, "Key Statements from Consultation"),
                                    react_1["default"].createElement("div", { className: "space-y-3" }, topicData.extractedSentences.map(function (sentence, idx) { return (react_1["default"].createElement("div", { key: idx, className: "flex items-start" },
                                        react_1["default"].createElement("div", { className: cx("flex-shrink-0 w-2 h-2 rounded-full mt-2 mr-4", isDarkMode ? "bg-blue-400" : "bg-blue-600") }),
                                        react_1["default"].createElement("p", { className: cx("text-base leading-relaxed", isDarkMode
                                                ? "text-slate-300"
                                                : "text-gray-700") },
                            ...
                            index <
                                Object.keys(patientData.consultationTopics).length -
                                    1 && (react_1["default"].createElement("div", { className: cx("mt-12 border-b", isDarkMode ? "border-slate-700" : "border-gray-200") }))));
                    })))),
            react_1["default"].createElement("div", { className: cx(isDarkMode
