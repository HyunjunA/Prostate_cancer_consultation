                ...
                react_1["default"].createElement("div", { className: "px-12 py-10" },
                    react_1["default"].createElement("div", { className: "text-center" },
                        ...
                        react_1["default"].createElement("div", { className: "mb-8 no-print" },
                            react_1["default"].createElement("button", { onClick: handleDownloadPdf, className: cx("inline-flex items-center gap-2 px-6 py-3 rounded-lg font-medium transition-all", isDarkMode
