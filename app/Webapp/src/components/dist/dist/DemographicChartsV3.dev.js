...
function DemographicCharts() {
  var _this = this; // 각 데이터셋에 대한 개별 상태 관리


  var _a = react_1.useState(null),
      genderIdentityData = _a[0],
      setGenderIdentityData = _a[1];

  var _b = react_1.useState(null),
      legalSexData = _b[0],
      setLegalSexData = _b[1];

  var _c = react_1.useState(null),
      sexualOrientationData = _c[0],
      setSexualOrientationData = _c[1];

  var _d = react_1.useState(null),
      maritalStatusData = _d[0],
      setMaritalStatusData = _d[1];

  var _e = react_1.useState(null),
      veteranStatusData = _e[0],
      setVeteranStatusData = _e[1];
  ...
  var _g = react_1.useState(null),
      ethnicityData = _g[0],
      setEthnicityData = _g[1];

  var _h = react_1.useState(null),
      languagesData = _h[0],
      setLanguagesData = _h[1];

  var _j = react_1.useState(null),
      needInterpreterData = _j[0],
      setNeedInterpreterData = _j[1];

  var _k = react_1.useState(null),
      religionData = _k[0],
      setReligionData = _k[1];
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            case 0:
              ...
              return [4
              /*yield*/
              , Promise.all([fetch("/json_data/demo_gender_identity_distribution.json").then(function (res) {
                return res.json();
              }), fetch("/json_data/demo_legal_sex_distribution.json").then(function (res) {
                return res.json();
              }), fetch("/json_data/demo_sexual_orientation_distribution.json").then(function (res) {
                return res.json();
              }), fetch("/json_data/demo_marital_status_distribution.json").then(function (res) {
                return res.json();
              }), fetch("/json_data/demo_veteran_status_distribution.json").then(function (res) {
                return res.json();
                ...
                return res.json();
              }), fetch("/json_data/demo_need_interpreter_distribution.json").then(function (res) {
                return res.json();
                ...
                return res.json();
              }), fetch("/json_data/age_distribution.json").then(function (res) {
                return res.json();
              })])];

            case 1:
              _a = _b.sent(), genderIdentity = _a[0], legalSex = _a[1], sexualOrientation = _a[2], maritalStatus = _a[3], veteranStatus = _a[4], race = _a[5], ethnicity = _a[6], languages = _a[7], needInterpreter = _a[8], religion = _a[9], state = _a[10], country = _a[11], city = _a[12], occupation = _a[13], age = _a[14]; // 각 상태 업데이트
  ...
  return React.createElement("div", {
  ...
  }, "Demographic Analysis"), React.createElement("div", {
    className: "w-full space-y-8"
  }, ageData && React.createElement("div", {
    className: "w-full"
  }, React.createElement("h2", {
    className: "text-2xl font-bold mb-6 text-center"
  }, "Age Distribution"), React.createElement("div", {
    ...
    className: "flex justify-center"
  }, React.createElement(Histogram_1.Histogram, {
    data: ageData,
    ...
    height: 400,
    bins: 30
  })))))), genderIdentityData && React.createElement("div", {
    className: "w-full"
  }, React.createElement("h2", {
    className: "text-2xl font-bold mb-6 text-center"
  }, genderIdentityData.title), React.createElement("div", {
    className: "flex justify-center"
  }, React.createElement("div", {
    className: "w-[80%]"
  }, React.createElement(card_1.Card, {
  ...
  }, React.createElement(BarChart_1.BarChart, {
    data: genderIdentityData.data,
    title: genderIdentityData.title,
    id: "gender-identity-bar",
    width: 500,
    height: 400
  }), React.createElement(PieChartV3_1.PieChartV3, {
    data: genderIdentityData.data,
    title: genderIdentityData.title,
    id: "gender-identity-pie",
    width: 500,
    height: 400
  })))))), legalSexData && React.createElement("div", {
    className: "w-full"
  }, React.createElement("h2", {
    className: "text-2xl font-bold mb-6 text-center"
  }, legalSexData.title), React.createElement("div", {
    className: "flex justify-center"
  }, React.createElement("div", {
    className: "w-[80%]"
  }, React.createElement(card_1.Card, {
    ...
    width: 500,
    height: 400
  })))))), raceData && React.createElement("div", {
    className: "w-full"
  }, React.createElement("h2", {
    className: "text-2xl font-bold mb-6 text-center"
  }, raceData.title), React.createElement("div", {
    className: "flex justify-center"
  }, React.createElement("div", {
    className: "w-[80%]"
  }, React.createElement(card_1.Card, {
    ...
    width: 500,
    height: 400
  })))))), ethnicityData && React.createElement("div", {
    className: "w-full"
  }, React.createElement("h2", {
    className: "text-2xl font-bold mb-6 text-center"
  }, ethnicityData.title), React.createElement("div", {
    className: "flex justify-center"
  }, React.createElement("div", {
    className: "w-[80%]"
  }, React.createElement(card_1.Card, {
    ...
    width: 500,
    height: 400
  })))))), religionData && React.createElement("div", {
    className: "w-full"
  }, React.createElement("h2", {
    className: "text-2xl font-bold mb-6 text-center"
  }, religionData.title), React.createElement("div", {
    className: "flex justify-center"
  }, React.createElement("div", {
    className: "w-[80%]"
  }, React.createElement(card_1.Card, {
    ...
    width: 500,
    height: 400
  })))))), countryData && React.createElement("div", {
    className: "w-full"
  }, React.createElement("h2", {
    className: "text-2xl font-bold mb-6 text-center"
  }, countryData.title), React.createElement("div", {
    className: "flex justify-center"
  }, React.createElement("div", {
    className: "w-[80%]"
  }, React.createElement(card_1.Card, {
    ...
    width: 500,
    height: 400
  })))))), cityData && React.createElement("div", {
    className: "w-full"
  }, React.createElement("h2", {
    className: "text-2xl font-bold mb-6 text-center"
  }, cityData.title, " "), React.createElement("div", {
    className: "flex justify-center"
  }, React.createElement("div", {
    className: "w-[80%]"
  }, React.createElement(card_1.Card, {
    ...
    width: 500,
    height: 400
  })))))), occupationData && React.createElement("div", {
    className: "w-full"
  }, React.createElement("h2", {
    className: "text-2xl font-bold mb-6 text-center"
  }, occupationData.title, " "), React.createElement("div", {
    className: "flex justify-center"
  }, React.createElement("div", {
    className: "w-[80%]"
  }, React.createElement(card_1.Card, {
