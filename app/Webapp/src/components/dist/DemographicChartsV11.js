...
function DemographicCharts() {
    var _this = this;
    // 각 데이터셋에 대한 개별 상태 관리
    var _a = useState(null), genderIdentityData = _a[0], setGenderIdentityData = _a[1];
    var _b = useState(null), legalSexData = _b[0], setLegalSexData = _b[1];
    var _c = useState(null), sexualOrientationData = _c[0], setSexualOrientationData = _c[1];
    var _d = useState(null), maritalStatusData = _d[0], setMaritalStatusData = _d[1];
    var _e = useState(null), veteranStatusData = _e[0], setVeteranStatusData = _e[1];
    var _f = useState(null), raceData = _f[0], setRaceData = _f[1];
    var _g = useState(null), ethnicityData = _g[0], setEthnicityData = _g[1];
    var _h = useState(null), languagesData = _h[0], setLanguagesData = _h[1];
    var _j = useState(null), needInterpreterData = _j[0], setNeedInterpreterData = _j[1];
    var _k = useState(null), religionData = _k[0], setReligionData = _k[1];
    var _l = useState(null), stateData = _l[0], setStateData = _l[1];
    var _m = useState(null), countryData = _m[0], setCountryData = _m[1];
    var _o = useState(null), cityData = _o[0], setCityData = _o[1];
    var _p = useState(null), occupationData = _p[0], setOccupationData = _p[1];
    var _q = useState(null), ageData = _q[0], setAgeData = _q[1];
    var _r = useState(null), age_marital_status_distribution = _r[0], setAgeMaritalStatusDistribution = _r[1];
    useEffect(function () {
    ...
    var _s = useState("all"), activeSection = _s[0], setActiveSection = _s[1];
    var _t = useState(false), isCompact = _t[0], setIsCompact = _t[1];
    var _u = useState(new Set()), selectedCharts = _u[0], setSelectedCharts = _u[1];
    var _v = useState(true), isSettingsOpen = _v[0], setIsSettingsOpen = _v[1];
    var chartOptions = [
