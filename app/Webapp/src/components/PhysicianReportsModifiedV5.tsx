        ...
        "Cancer Prognosis": {
          ...
          sentenceDetails: [
            ...
            },
            {
              i: 0,
              i2: 3,
              sentence: "We would treat with surgery or radiation",
              score: 2,
            },
            {
              i: 0,
          ...
          sentenceDetails: [
            {
              i: 1,
              i2: 0,
              sentence: "Now, this is based on your age and at 71, on average",
              score: 2,
            },
            {
              i: 1,
              i2: 1,
              sentence: "you have about 13 years life expectancy",
              score: 3,
            },
            {
              i: 1,
              i2: 2,
              sentence: "We want to plan for those 40 years",
              score: 2,
            },
          ],
        },
          ...
          sentenceDetails: [
            {
              i: 2,
              i2: 0,
              sentence: "For erectile function, I quoted you a 40–50% chance",
              score: 3,
            },
            {
              i: 2,
              i2: 1,
              sentence: "of getting to your baseline function",
              score: 2,
            },
          ],
        },
          ...
          sentenceDetails: [
            {
              i: 3,
              i2: 0,
              sentence: "By one year ~90% of men will not need a pad",
              score: 4,
            },
            {
              i: 3,
          ...
          sentenceDetails: [
            {
              i: 4,
              i2: 0,
              sentence: "You don't really have many urinary symptoms now",
              score: 2,
            },
            {
              i: 4,
          ...
          const updated = patients.map((p) => {
            ...
            return {
              ...
              topics: {
                ...
                [topicName]: {
                  ...prevTopic,
                  sentences: [newSentence, ...prevTopic.sentences],
          ...
          {showRewrite && (
            ...
            >
              ...
              <div className="mb-4">
                ...
                >
                  "{data.sentences[0] || "No sentence available"}"
                </div>
              </div>
