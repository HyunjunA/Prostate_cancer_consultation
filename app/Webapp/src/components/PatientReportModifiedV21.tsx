...
const PatientReport: React.FC<PatientReportProps> = ({
  ...
  // patientId from URL (?pat=xxx) or localStorage, fallback to default
  const [currentFile] = useState("quality-coded-nlp-pilot-sid-1.xlsx");
  ...
  useEffect(() => {
    ...
    loadSummaryData();
  }, [currentFile, currentSpeaker, patientId]);
