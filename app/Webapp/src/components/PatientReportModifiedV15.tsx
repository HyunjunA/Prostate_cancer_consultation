...
// ⭐ NEW: Import from components/surveys
import {
...
/* =============================================================================
   SECTION 5: QUESTION DATA CONSTANTS
============================================================================= */
...
const PatientReport: React.FC<PatientReportProps> = ({
  ...
  const handleSubmitQuestions = async () => {
    try {
      const result = await submitSurvey({
        ...
        file: patientData?.patientId || "unknown",
        speaker: patientData?.patientName || "unknown",
  ...
  const handleSubmitSDM = async () => {
    try {
      ...
      console.error("❌ SDM submission failed:", error);
      alert("Failed to submit. Please try again.");
    }
  };
  ...
  const handleSubmitBaseline = async () => {
    try {
      ...
      console.error("❌ Baseline submission failed:", error);
      alert("Failed to submit. Please try again.");
    }
  };
  ...
  const handleSubmitDCS = async () => {
    try {
      ...
      console.error("❌ DCS submission failed:", error);
      alert("Failed to submit. Please try again.");
    }
  };

  // ⭐ NEW: Risk Perception Handlers
  ...
  const handleSubmitRisk = async () => {
    try {
      ...
      console.error("❌ Risk Perception submission failed:", error);
      alert("Failed to submit. Please try again.");
    }
  };

  // ⭐ NEW: Patient Satisfaction Handlers
  ...
  const handleSubmitSatisfaction = async () => {
    try {
      ...
      console.error("❌ Satisfaction submission failed:", error);
      alert("Failed to submit. Please try again.");
    }
  };
          ...
          >
            <div className="px-6 lg:px-12 py-12 grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-10">
              ...
              <div>
                ...
                {/* ═══════════════════════════════════════════════════════════
                    ⭐ NEW: DECISIONAL CONFLICT SURVEY SECTION
                ═══════════════════════════════════════════════════════════ */}
                {isDCSTab && (
                ...
                {/* ═══════════════════════════════════════════════════════════
                    ⭐ NEW: RISK PERCEPTION SURVEY SECTION
                ═══════════════════════════════════════════════════════════ */}
                {isRiskTab && (
                ...
                {/* ═══════════════════════════════════════════════════════════
                    ⭐ NEW: PATIENT SATISFACTION SURVEY SECTION
                ═══════════════════════════════════════════════════════════ */}
                {isSatisfactionTab && (
                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      {/* ⭐ NEW: Decisional Conflict Button */}
                      <button
                        type="button"
                      ...
                      {/* ⭐ NEW: Patient Satisfaction Button */}
                      <button
                        type="button"
