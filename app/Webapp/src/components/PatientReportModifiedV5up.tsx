...
const StarRating: React.FC<{
  ...
  label?: string;
  isDark?: boolean;
  trackingName?: string; // ⭐ NEW: for cursor proximity tracking
        ...
        >
          <div className="px-12 py-10">
            <div className="text-center">
              ...
              {/* PDF Download Button - ⭐ TRACKING ADDED */}
              ...
              {/* View mode toggle - ⭐ TRACKING ADDED */}
              <div className="mb-8 no-print">
                <div
                  className={cx(
        ...
        {viewMode === "topics" ? (
          ...
          >
            <div className="px-6 lg:px-12 py-12 grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-10">
              {/* MAIN COLUMN */}
              <div>
                {/* CHANGE 1: Overall Summary shown ONLY on landing (activeTab === null) - ⭐ TRACKING ADDED */}
                {activeTab === null && (
                  <section
                ...
                {activeTab !== null && (
                  <section>
                    ...
                    {/* Topic Summary + Rating - ⭐ TRACKING ADDED */}
                    <div
                    ...
                    {/* CHANGE 6: Key Statements BELOW Summary (collapsed by default) - ⭐ TRACKING ADDED */}
                    <div className="mb-8">
                      <button
                        type="button"
              ...
              {/* CHANGE 2: Right Sidebar Navigation - ⭐ TRACKING ADDED */}
          ...
          >
            <div className="px-12 py-12">
              ...
              {/* Overall Summary at top (full mode) - ⭐ TRACKING ADDED */}
              <section
              ...
              {/* ⭐ TRACKING ADDED to all full mode topics */}
              {Object.entries<any>(patientData.consultationTopics).map(
                ([topicName, topicData], index) => (
                  ...
                  >
                    ...
                    {/* CHANGE 6 (full-mode): Key Statements BELOW Summary - ⭐ TRACKING ADDED */}
                    <div className="mb-12">
                      <button
                        type="button"
