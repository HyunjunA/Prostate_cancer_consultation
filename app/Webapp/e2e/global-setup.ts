 ...
 *
 * Loads `app/Backend/.env.native` into process.env so spec files can
...
async function globalSetup(): Promise<void> {
  ...
  if (!fs.existsSync(envNative)) {
    // No .env.native locally — assume CI is exporting the secrets
