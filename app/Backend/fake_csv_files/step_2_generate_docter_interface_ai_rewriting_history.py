...
sampled_rows = sampled_rows[ordered_columns]

# ===== Step 6. 결과 저장 =====
sampled_rows.to_csv(output_path, index=False, encoding="utf-8-sig")

print(f"✅ 완료! {len(sampled_rows)}개의 행이 선택되어 저장되었습니다.")
print(f"📄 결과 파일: {output_path}")
print("📊 결과 예시:")
print(sampled_rows.head(10))
